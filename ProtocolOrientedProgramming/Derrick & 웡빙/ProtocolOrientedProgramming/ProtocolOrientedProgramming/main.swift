...
let apple = Charger(name: "apple", maximumWattPerHour: 5)
...
let mackBook = Macbook(name: "macbook", allowedChargeWattPerHour: 30, currentBatterryAmount: 20, maxBattertyAmount: 100)
